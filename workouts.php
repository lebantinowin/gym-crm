...
<body class="flex flex-col min-h-screen bg-gray-50">
    ...
    <div id="userNavDrawer" class="md:hidden hidden bg-primary text-white border-t border-gray-800 shadow-lg sticky top-0 z-40">
        <div class="px-4 py-3 space-y-1">
            ...
            <a href="workouts.php" class="flex items-center px-4 py-3 rounded-lg bg-highlight text-white">
    ...
    <main class="flex-grow container mx-auto px-4 py-8">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            ...
            <button id="logWorkoutBtn" class="btn-primary px-4 py-2 rounded-lg flex items-center whitespace-nowrap">
