...
<body class="flex flex-col min-h-screen bg-gray-50">
    ...
    <!-- Mobile nav drawer (user-facing) -->
    <div id="userNavDrawer" class="md:hidden hidden bg-primary text-white border-t border-gray-800 shadow-lg sticky top-16 z-40">
        <div class="px-4 py-3 space-y-1">
            <a href="dashboard.php" class="flex items-center px-4 py-3 rounded-lg font-semibold text-highlight">
